...
public class RolesOperations
{
	 ...
	 * @throws SDKException
	 */
	public APIResponse<ActionHandler> updateRole(Long id, BodyWrapper request) throws SDKException
	{
		CommonAPIHandler handlerInstance = new CommonAPIHandler();
	 ...
	 * @throws SDKException
	 */
	public APIResponse<ActionHandler> deleteRole(Long id, ParameterMap paramInstance) throws SDKException
	{
		CommonAPIHandler handlerInstance = new CommonAPIHandler();
