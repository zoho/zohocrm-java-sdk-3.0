...
public class Utility
{
	...
	public static Object getFieldsDetails(String moduleAPIName) throws SDKException
	{
		...
		FieldsOperations fieldOperation = new FieldsOperations(moduleAPIName, null);
	...
	private static void setDataType(JSONObject fieldDetail, Field field, String moduleAPIName) throws SDKException
	{
		...
		com.zoho.crm.api.fields.Module module = new com.zoho.crm.api.fields.Module();
		...
		if(apiType.toLowerCase().equalsIgnoreCase(Constants.MULTI_SELECT_LOOKUP))
		{
			...
			if(field.getMultiselectlookup() != null)
			{
				...
				{
					com.zoho.crm.api.fields.Module linkingModule = field.getMultiselectlookup().getLinkingModule();
		...
		if(apiType.toLowerCase().equalsIgnoreCase(Constants.MULTI_USER_LOOKUP))
		{
			...
			if(field.getMultiuserlookup() != null)
			{
				...
				{
					com.zoho.crm.api.fields.Module linkingModule = field.getMultiuserlookup().getLinkingModule();
		...
		if (apiType.equalsIgnoreCase(Constants.LOOKUP) && field.getLookup() != null)
		{
			...
			if (module != null && !module.getAPIName().equalsIgnoreCase(Constants.SE_MODULE))
			{
				fieldDetail.put(Constants.MODULE, module.getAPIName());
				
				if(module.getAPIName().equalsIgnoreCase(Constants.ACCOUNTS) && !field.getCustomField())
				{
					fieldDetail.put(Constants.SKIP_MANDATORY, true);
				}
			}
			...
			{
				module = new com.zoho.crm.api.fields.Module();
			}
