...
{
	/*
	 * <h3> get Email Addresses</h3> This method is used to get Email Addresses
	 * 
	 * @throws Exception
	 */
	...
	public static void sendMail(Long recordID, String moduleAPIName) throws Exception
	{
		...
		for (int i = 1; i <= 1; i++)
		{
			...
			attachment.setId("2cceafa194db0b4fe0949a982de89fa75a");
			...
			mail.setInReplyTo("2cceafa86486f1eb0360aee76d802b6d376dea97e7");
