...
import com.zoho.crm.api.usersunavailability.UsersUnavailabilityOperations.GetUsersUnavailabilityHoursParam;
...
//		paramInstance.add(GetUsersUnavailabilityHoursParam.GROUP_IDS, "347706109,34770610912");
//
//		paramInstance.add(GetUsersUnavailabilityHoursParam.INCLUDE_INNER_DETAILS, "56xxx8");
//		
//		paramInstance.add(GetUsersUnavailabilityHoursParam.ROLE_IDS, "3433706109,34037061091");
//		
//		paramInstance.add(GetUsersUnavailabilityHoursParam.TERRITORY_IDS, "3433706109,34037061091");
		...
		criteria2.put("field", criteria1Field);
		...
		paramInstance.add(GetUsersUnavailabilityHoursParam.FILTERS, filters.toString());

		// Call getUsersUnavailabilityHours method that takes ParameterMap instance as parameters
		APIResponse<ResponseHandler> response = usersUnavailabilityOperations.getUsersUnavailabilityHours(paramInstance);
			...
			if (response.isExpected())
			{
				...
				if (responseHandler instanceof ResponseWrapper)
				{
					...
					for (com.zoho.crm.api.usersunavailability.UsersUnavailability usersUnavailability : users)
					{
						...
						com.zoho.crm.api.users.User user = usersUnavailability.getUser();
	...
	public static void getUserUnavailabilityHours(Long id) throws Exception
	{
		...
		APIResponse<ResponseHandler> response = usersUnavailabilityOperations.getUserUnavailabilityHours(id, paramInstance);
	...
	public static void usersUnavailabilityHours() throws Exception
	{
		...
		APIResponse<ActionHandler> response = usersOperations.usersUnavailabilityHours(request);
	...
	public static void updateUsersUnavailabilityHours() throws Exception
	{
		...
		APIResponse<ActionHandler> response = usersOperations.updateUsersUnavailabilityHours(request);
