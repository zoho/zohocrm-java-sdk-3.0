...
public class ScoringRule
{
			...
			if (response.isExpected())
			{
				...
				if (responseHandler instanceof ResponseWrapper)
				{
					...
					for (com.zoho.crm.api.scoringrules.ScoringRule scoringRule : scoringRules)
					{
						...
						User modifiedBy = scoringRule.getModifiedBy();
						...
						User createdBy = scoringRule.getCreatedBy();
	...
	public static void createScoringRules() throws Exception
	{
		...
		com.zoho.crm.api.fields.Field field1 = new com.zoho.crm.api.fields.Field();
		...
		field1 = new com.zoho.crm.api.fields.Field();
...
//		fieldRule.setDelete(null);
	...
	public static void deleteScoringRules() throws Exception
	{
		...
		paramInstance.add(DeleteScoringRulesParam.IDS, "347706114954004");
	...
	public static void scoringRuleExecutionUsingLayoutId(String moduleAPIName) throws Exception
	{
		...
		APIResponse<ActionResponse> response = scoringRulesOperations.scoringRuleExecutionUsingLayoutId(moduleAPIName, bodyWrapper);
