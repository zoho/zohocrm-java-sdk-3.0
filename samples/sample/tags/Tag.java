...
//		}
		...
		APIResponse<RecordActionHandler> response = tagsOperations.addTagsToRecord(recordId, moduleAPIName, request, paramInstance);
						...
						if (actionResponse instanceof SuccessResponse)
						{
							...
							for (Map.Entry<String, Object> entry : successResponse.getDetails().entrySet())
							{
								if (entry.getKey().equals("tags"))
								{
									...
									List<com.zoho.crm.api.tags.Tag> tags = (List<com.zoho.crm.api.tags.Tag>) entry.getValue();
...
//		}
		...
		APIResponse<RecordActionHandler> response = tagsOperations.removeTagsFromRecord(recordId, moduleAPIName, request, paramInstance);
